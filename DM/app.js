const products = [
  { name: "Windeln", category: "Baby", image: "bilder/Windeln-1.png", task: "Express-Bestellung: Größe prüfen, Packung unbeschädigt nehmen und in die Baby-Kiste legen.", level: "starter", icon: "windel" },
  { name: "Baby-Feuchttücher", category: "Baby", image: "bilder/Baby-Feuchtuecher-1.png", task: "Neben den Windeln auffüllen. Vorderkante bündig ziehen.", level: "starter", icon: "tücher" },
  { name: "Shampoo", category: "Haarpflege", image: "bilder/Shampo-1.png", task: "Flaschen nach vorne ziehen, Verschluss nach oben, Etikett nach vorne.", level: "starter", icon: "shampoo" },
  { name: "Zahnpasta", category: "Zahnpflege", image: "bilder/Zahnpasta-1.png", task: "Kartons ordentlich stapeln und die Sorte auf dem Preisschild prüfen.", level: "starter", icon: "zahn" },
  { name: "Zahnbürste", category: "Zahnpflege", image: "", task: "Haken auffüllen. Gleiche Farben und Sorten zusammen hängen.", level: "core", icon: "bürste" },
  { name: "Gesichtscreme", category: "Hautpflege", image: "", task: "Tiegel mit sauberem Deckel nach vorne stellen und beschädigte Ware melden.", level: "starter", icon: "creme" },
  { name: "Bodylotion", category: "Hautpflege", image: "", task: "Pumpflaschen gerade ausrichten. Kurze Flaschen vorne, hohe hinten.", level: "core", icon: "lotion" },
  { name: "Mascara", category: "Kosmetik", image: "", task: "Aufsteller befüllen: Tester nicht verkaufen, neue Ware in die freien Fächer legen.", level: "starter", icon: "mascara" },
  { name: "Lippenpflege", category: "Kosmetik", image: "", task: "Kleine Ware sauber sortieren und fehlende Sorten aufschreiben.", level: "core", icon: "lippe" },
  { name: "Bio-Müsli", category: "Bio-Produkte", image: "", task: "MHD prüfen. Ältere Packungen nach vorne, neue Packungen nach hinten.", level: "starter", icon: "bio" },
  { name: "Bio-Tee", category: "Bio-Produkte", image: "", task: "Sorten zusammenstellen und das Preisschild mit dem Produkt vergleichen.", level: "core", icon: "tee" },
  { name: "Bio-Saft", category: "Bio-Produkte", image: "", task: "MHD prüfen. Flaschen vorsichtig drehen und ältere Ware nach vorne stellen.", level: "core", icon: "bio" },
  { name: "Babygläschen Karotte", category: "Babynahrung", image: "", task: "Glas auf Sprünge prüfen. MHD kontrollieren und ältere Gläschen nach vorne stellen.", level: "starter", icon: "glas" },
  { name: "Babygläschen Apfel", category: "Babynahrung", image: "", task: "Deckel prüfen. Gläschen nach Sorte ordnen und das Mindesthaltbarkeitsdatum lesen.", level: "core", icon: "glas" },
  { name: "Babybrei Abendbrei", category: "Babynahrung", image: "", task: "Packung trocken und sauber einräumen. MHD und Sorte mit dem Schild vergleichen.", level: "core", icon: "brei" },
  { name: "Schokoladenriegel", category: "Süßwaren", image: "", task: "MHD prüfen. Riegel mit kurzem Datum nach vorne legen und beschädigte Ware melden.", level: "starter", icon: "riegel" },
  { name: "Traubenzucker", category: "Süßwaren", image: "", task: "Kleine Packungen gerade ausrichten und fehlende Sorten notieren.", level: "core", icon: "riegel" },
  { name: "Rasiergel", category: "Männerpflege", image: "", task: "Dosen aufrecht stellen. Verschluss und Etikett nach vorne ausrichten.", level: "starter", icon: "rasur" },
  { name: "Aftershave", category: "Männerpflege", image: "", task: "Flaschen vorsichtig einräumen und Glasverpackungen nicht an die Regalkante stellen.", level: "core", icon: "rasur" },
  { name: "Deo Männer", category: "Männerpflege", image: "", task: "Spraydosen nach Duft sortieren und leere Plätze im Regal melden.", level: "core", icon: "deo" },
  { name: "Parfüm Damen", category: "Parfüm", image: "", task: "Verpackung sauber hinstellen. Tester und Verkaufsware getrennt lassen.", level: "core", icon: "parfum" },
  { name: "Parfüm Herren", category: "Parfüm", image: "", task: "Sicher in den Aufsteller stellen und das Preisschild mit dem Duft vergleichen.", level: "core", icon: "parfum" },
  { name: "Waschmittel", category: "Haushaltswaren", image: "", task: "Schwere Flaschen sicher anfassen und nicht über Schulterhöhe stapeln.", level: "starter", icon: "wasch" },
  { name: "Spülmittel", category: "Haushaltswaren", image: "", task: "Flaschen gerade stellen und ausgelaufene Ware sofort melden.", level: "starter", icon: "spül" },
  { name: "Küchenrolle", category: "Haushaltswaren", image: "", task: "Große Ware unten einräumen, damit das Regal sicher bleibt.", level: "core", icon: "rolle" },
  { name: "Fotopapier", category: "Foto-Service", image: "", task: "Beim Fotoautomaten Papierfach nur mit Anleitung einer Fachkraft öffnen.", level: "all", icon: "foto" },
  { name: "Kopierpapier", category: "Kopier-Service", image: "", task: "Kunden beim Kopieren helfen: Vorlagen richtig auflegen und Starttaste erklären.", level: "all", icon: "kopie" }
];
