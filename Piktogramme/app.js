const appTitle = "Piktogramme";
const introSpeech = "Hallo. Ich helfe dir beim Üben mit Piktogrammen.";
const repeatSpeech = "Die Piktogramm-App ist bereit. Tippe auf Stimme testen, Neue Aufgabe oder einen Modus.";

const modeTexts = {
  learn: "Lernen: Wir hören Begriffe und ordnen passende Piktogramme zu.",
  category: "Überbegriffe: Wir sortieren Piktogramme nach Themen und Bereichen.",
  express: "Express: Wir üben kurze Aufgaben mit schnellem Wechsel.",
  date: "MHD: Wir achten auf wichtige Datumsangaben und Hinweise.",
  display: "Aufsteller: Wir ordnen Symbole und Hinweise passend an.",
  dialog: "Dialog: Wir sprechen einfache Sätze zu Situationen im Alltag."
};

const levelTexts = {
  starter: "Start aktiviert. Es werden einfache Piktogramme geübt.",
  core: "Mehr Inhalte aktiviert. Zusätzliche Piktogramme kommen dazu.",
  all: "Alles üben aktiviert. Alle vorhandenen Bereiche sind freigeschaltet."
};
